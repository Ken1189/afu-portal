...
('mtn_momo', 'MTN Mobile Money', 'Enable MTN MoMo payments', false, ARRAY['NG','ZM'], 'payments'),
...
('ussd_channel', 'USSD Menu', 'Enable USSD shortcode for feature phones', false, ARRAY['KE','TZ','ZW'], 'integrations'),
