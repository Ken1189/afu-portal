...
('general', 'Which countries does AFU operate in?', 'AFU currently operates in 10 African countries: Botswana, Zimbabwe, Tanzania, Kenya, Uganda, Zambia, Sierra Leone, Nigeria, Mozambique, and South Africa. Phase 1 launched in Zimbabwe, Botswana, and Tanzania.', 2),
