...
export default function SupplierInventoryPage() {
  ...
  return (
    <div className="space-y-6 py-4">
      ...
      {loading ? <div className="flex flex-col items-center justify-center py-16 gap-3"><Loader2 className="w-8 h-8 animate-spin text-[#5DB347]" /><p className="text-sm text-gray-400">Loading...</p></div> : filtered.length === 0 ? (
