...
const FALLBACK_ALL_COMMISSIONS: Commission[] = [
  ...
  { id: 'COM-026', supplierId: 'SUP-019', supplierName: 'Mmegi Digital Agriculture', orderId: 'ORD-2026-0258', productName: 'FarmTrack Pro Licence x 50', buyerName: 'AFU Botswana Chapter', buyerType: 'cooperative', orderAmount: 6000, commissionRate: 14, commissionAmount: 840, status: 'pending', orderDate: '2026-03-11', paymentDate: null },
