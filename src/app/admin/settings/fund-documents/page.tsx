              ...
              <tr key={doc.id} className="border-b border-gray-50 hover:bg-gray-50/50">
                ...
                <td className="px-5 py-3 text-right">
                  <div className="flex items-center justify-end gap-1">
                    <button onClick={() => openEdit(doc)} className="p-2 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-[#1B2A4A]">
                      <Pencil className="w-4 h-4" />
                    </button>
                    <button onClick={() => handleDelete(doc.id)} className="p-2 rounded-lg hover:bg-red-50 text-gray-500 hover:text-red-600">
