...
export const DEFAULT_CONTENT: Record<string, Record<string, unknown>> = {
  homepage: {
    ...
    stats_subtitle: "Africa has the land, labour, and demand. What's missing is the integrated infrastructure and finance to unlock it.",
    services_eyebrow: 'Our Services',
    services_title: 'One Platform, Complete Value Chain',
    services_subtitle: "A vertically integrated agriculture development platform — the specialised agri dev bank and execution engine Africa has been missing.",
    ...
    ai_body: 'Our Amara AI assistant helps farmers with crop diagnostics, market pricing, weather alerts, and personalised recommendations — accessible via the portal or WhatsApp.',
    ai_features: [
    ...
    sponsor_subtitle: "Real farmers. Real crops. Real impact. Your sponsorship is distributed across farmers who need it most — funding memberships, inputs, and programme access. Get monthly updates as their seasons unfold.",
