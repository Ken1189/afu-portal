...
const _UNUSED_FALLBACK_ENROLLMENT_TREND = [
...
const _UNUSED_FALLBACK_REVENUE_TREND = [
...
export default function AdminCarbonDashboard() {
  ...
  const [kpis, setKPIs] = useState({ totalProjects: 0, activeEnrollments: 0, creditsIssued: 0, creditsSold: 0, totalRevenue: 0, bufferPool: 0 });
  ...
  const [activity, setActivity] = useState<{ type: string; text: string; time: string }[]>([]);
