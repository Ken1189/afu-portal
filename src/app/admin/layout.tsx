...
const navGroups: NavGroup[] = [
  ...
  // ── 3. Finance ──
  {
    ...
    defaultOpen: false,
    links: [
      { href: '/admin/financial', label: 'Financial Overview', icon: <TrendingUp className={ICON_CLS} /> },
      ...
      { href: '/admin/orders', label: 'Orders', icon: <ShoppingCart className={ICON_CLS} /> },
  ...
  // ── 6. Content ──
  {
    ...
    links: [
      ...
      { href: '/admin/settings/homepage-services', label: 'Homepage Services', icon: <Layers className={ICON_CLS} /> },
      { href: '/admin/content/ambassadors', label: 'Ambassadors Page', icon: <PenSquare className={ICON_CLS} /> },
  ...
  // ── 8. Marketing ──
  {
    ...
    links: [
      ...
      { href: '/admin/newsletter', label: 'Newsletter Subs', icon: <Mail className={ICON_CLS} /> },
      { href: '/admin/podcasts', label: 'Podcast Subs', icon: <Mic className={ICON_CLS} /> },
  ...
  // ── 9. Settings ──
  {
    ...
    links: [
      ...
      { href: '/admin/audit-trail', label: 'Audit Trail', icon: <ScanEye className={ICON_CLS} /> },
    ...
    <div className="min-h-screen bg-cream flex">
      ...
      >
        <header className="bg-white border-b border-gray-100 px-4 sm:px-6 py-3 flex items-center justify-between sticky top-0 z-20">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" target="_blank" className="flex items-center gap-1 text-xs text-gray-400 hover:text-white px-3 py-1.5 rounded-lg hover:bg-[#1B2A4A]">
