...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/admin/settings/supplier-verification', label: 'Supplier Verification', icon: <ShieldCheck className={ICON_CLS} /> },
  ...
  },
  {
    ...
    defaultOpen: true,
    links: [
      { href: '/admin/ambassadors', label: 'Ambassador Hub', icon: <Megaphone className={ICON_CLS} /> },
      { href: '/admin/suppliers', label: 'Supplier Hub', icon: <Store className={ICON_CLS} /> },
      { href: '/admin/warehouse', label: 'Warehouse Hub', icon: <Warehouse className={ICON_CLS} /> },
      { href: '/admin/farm-overview', label: 'Farm Overview', icon: <Tractor className={ICON_CLS} /> },
      { href: '/admin/investor-relations', label: 'Investor Pipeline', icon: <Landmark className={ICON_CLS} /> },
      { href: '/admin/farmers', label: 'Farmer Management', icon: <Users className={ICON_CLS} /> },
    ],
  },
  {
    label: 'Switch Portal',
