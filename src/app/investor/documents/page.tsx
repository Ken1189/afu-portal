...
export default function DocumentsPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        // 1. Get investor profile to scope documents
        ...
        // 2. Try investor_documents table first, scoped to this investor
        if (ip) {
        ...
        // 3. Try investor_documents without profile filter (shared fund docs)
        ...
        // 4. Fall back to documents table
        ...
        // 5. Try Supabase storage bucket listing as last resort
