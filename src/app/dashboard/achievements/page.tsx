...
const badges: Badge[] = [
  ...
  { id: 'certified-pro', name: 'Certified Pro', description: 'Earn an official certification from the AFU training program.', icon: Medal, category: 'education', rarity: 'epic', requirement: 'Earn a certification', points: 100 },
