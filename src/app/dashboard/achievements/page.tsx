...
const badges: Badge[] = [
  { id: 'first-steps', name: 'First Steps', description: 'Complete the onboarding process and join the AFU community.', icon: Footprints, category: 'onboarding', rarity: 'common', requirement: 'Complete onboarding', points: 10 },
  { id: 'profile-perfect', name: 'Profile Perfect', description: 'Fill out every section of your farmer profile to 100%.', icon: Sparkles, category: 'onboarding', rarity: 'common', requirement: '100% profile completion', points: 15 },
  { id: 'verified-farmer', name: 'Verified Farmer', description: 'Complete KYC verification and become a trusted member.', icon: ShieldCheck, category: 'onboarding', rarity: 'uncommon', requirement: 'Complete KYC verification', points: 25 },
  { id: 'green-thumb', name: 'Green Thumb', description: 'Create your first farm plot and start your digital farming journey.', icon: Sprout, category: 'farming', rarity: 'common', requirement: 'Create first farm plot', points: 10 },
  { id: 'harvest-hero', name: 'Harvest Hero', description: 'Successfully complete your first harvest cycle.', icon: Wheat, category: 'farming', rarity: 'uncommon', requirement: 'Complete first harvest', points: 25 },
  { id: 'master-grower', name: 'Master Grower', description: 'Manage 5 or more active farm plots simultaneously.', icon: Tent, category: 'farming', rarity: 'rare', requirement: '5+ active plots', points: 50 },
  { id: 'soil-guardian', name: 'Soil Guardian', description: 'Achieve a soil health score above 90 on every one of your plots.', icon: Globe2, category: 'farming', rarity: 'epic', requirement: 'Health score > 90 on all plots', points: 100 },
  { id: 'first-payment', name: 'First Payment', description: 'Complete your first payment through the AFU platform.', icon: CreditCard, category: 'financial', rarity: 'common', requirement: 'Complete first payment', points: 10 },
  { id: 'perfect-record', name: 'Perfect Record', description: 'Maintain a flawless repayment history with 100% on-time payments.', icon: BarChart3, category: 'financial', rarity: 'rare', requirement: '100% on-time loan repayments', points: 75 },
  { id: 'credit-champion', name: 'Credit Champion', description: 'Achieve an exceptional credit score above 800.', icon: Crown, category: 'financial', rarity: 'legendary', requirement: 'Credit score > 800', points: 200 },
  { id: 'insured-farmer', name: 'Insured Farmer', description: 'Protect your farm by purchasing your first insurance policy.', icon: Umbrella, category: 'financial', rarity: 'uncommon', requirement: 'Purchase first insurance policy', points: 20 },
  { id: 'knowledge-seeker', name: 'Knowledge Seeker', description: 'Enroll in your first training course on the platform.', icon: BookOpen, category: 'education', rarity: 'common', requirement: 'Enroll in first course', points: 10 },
  { id: 'scholar', name: 'Scholar', description: 'Complete 3 training courses and broaden your expertise.', icon: GraduationCap, category: 'education', rarity: 'uncommon', requirement: 'Complete 3 courses', points: 30 },
  { id: 'expert-farmer', name: 'Expert Farmer', description: 'Complete 10 courses and become a true agricultural expert.', icon: Brain, category: 'education', rarity: 'rare', requirement: 'Complete 10 courses', points: 75 },
  { id: 'certified-pro', name: 'Certified Pro', description: 'Earn an official certification from the AFU training programme.', icon: Medal, category: 'education', rarity: 'epic', requirement: 'Earn a certification', points: 100 },
  { id: 'team-player', name: 'Team Player', description: 'Join a cooperative and start collaborating with fellow farmers.', icon: Handshake, category: 'community', rarity: 'common', requirement: 'Join a cooperative', points: 10 },
  { id: 'referral-champion', name: 'Referral Champion', description: 'Refer 5 or more farmers to join the AFU platform.', icon: Megaphone, category: 'community', rarity: 'uncommon', requirement: '5+ referrals', points: 30 },
  { id: 'community-leader', name: 'Community Leader', description: 'Become an officer in your cooperative and lead your community.', icon: Landmark, category: 'community', rarity: 'rare', requirement: 'Become a cooperative officer', points: 50 },
  { id: 'first-purchase', name: 'First Purchase', description: 'Buy your first product from the AFU marketplace.', icon: ShoppingCart, category: 'marketplace', rarity: 'common', requirement: 'Buy first product', points: 10 },
  { id: 'export-ready', name: 'Export Ready', description: 'Complete your first export transaction through the platform.', icon: Ship, category: 'marketplace', rarity: 'rare', requirement: 'Complete first export', points: 50 },
  { id: 'market-maven', name: 'Market Maven', description: 'Complete 10 or more marketplace transactions like a pro.', icon: Gem, category: 'marketplace', rarity: 'epic', requirement: '10+ marketplace transactions', points: 75 },
];
...
function BadgeCard({ badge, earned, earnedAt }: { badge: Badge; earned: boolean; earnedAt?: string }) {
  return (
    ...
    >
      ...
      >
        {earned ? (
          <badge.icon className="h-7 w-7 text-[#0B3D2C]" />
        ) : (
        ...
        >
          ...
          <div className="relative space-y-6">
            ...
            {recentAchievements.map((achievement, idx) => (
              ...
              >
                {/* Timeline dot */}
                <div className="relative z-10 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-white border-2 border-[#8CB89C] shadow-sm">
                  <achievement.badge.icon className="h-5 w-5 text-[#0B3D2C]" />
                </div>
