...
const FALLBACK_PRODUCTS: Product[] = [
  ...
  { id: 'PRD-018', name: 'Soil pH Testing Kit', category: 'Technology', description: 'Digital soil pH meter with buffer solutions. Essential for blueberry soil management.', price: 45, unit: 'per kit', image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=400&h=300&fit=crop', availability: 'in-stock', recommendedCrops: ['Blueberries', 'Cassava'], supplier: 'AgriTest SA', rating: 4.3 },
  ...
  { id: 'PRD-020', name: 'Shade Net (40% Green)', category: 'Equipment', description: 'UV-stabilized shade netting for nursery and young plant protection. 50m roll x 3m width.', price: 85, unit: 'per roll', image: 'https://images.unsplash.com/photo-1501004318855-cddc2a3a086a?w=400&h=300&fit=crop', availability: 'in-stock', recommendedCrops: ['Blueberries', 'Sesame'], supplier: 'AgriNet Zimbabwe', rating: 4.4 },
];
      ...
      try {
        ...
        if (!cancelled && data && data.length > 0) {
          const mapped: Product[] = data.map((p: Record<string, unknown>) => ({
            ...
            image: (p.image_url as string) || (p.image as string) || 'https://images.unsplash.com/photo-1487058792275-7f13abb78563?w=400&h=300&fit=crop',
