...
const fallbackPrograms = [
  ...
  },
  {
    ...
    status: 'Active',
    description:
      'Food security crops cultivated across all AFU operating countries. Building reliable staple supply chains connecting smallholder farmers to domestic and regional markets through aggregation, quality assurance, and guaranteed off-take.',
