        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-[#EBF7E5] rounded-lg flex items-center justify-center shrink-0">
                    <svg className="w-5 h-5 text-[#5DB347]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                <div className="bg-[#EBF7E5] rounded-2xl p-10 text-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        type="text"
                        required
                        className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5DB347]/50 focus:border-[#5DB347]"
                        value={formData.name}
                  ...
                  <div>
                    ...
                    <textarea
                      required
                      rows={5}
                      className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5DB347]/50 focus:border-[#5DB347] resize-none"
