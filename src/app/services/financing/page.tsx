      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="card-elevated bg-teal rounded-2xl p-8 text-white">
          ...
          <div className="card-elevated bg-teal-light rounded-2xl p-8 text-center">
            ...
            <Link href="/apply" className="inline-block bg-teal hover:bg-teal-dark text-white px-8 py-3 rounded-lg font-semibold transition-smooth">
              Apply for Financing
            </Link>
          </div>
        </div>
