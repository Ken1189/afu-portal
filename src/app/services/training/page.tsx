...
const features = [
  ...
  },
  {
    ...
    description:
      "200+ field-based extension officers across Africa deliver in-person training, monitor farmer progress, and provide on-farm advisory services in local languages.",
  },
];
    ...
    <>
      ...
      <section className="relative min-h-[520px] flex items-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1535303311164-664fc9ec6532?w=1920&h=1080&fit=crop')",
          }}
        />
        <div
