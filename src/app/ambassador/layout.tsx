...
const navLinks = [
  ...
  { href: '/ambassador/referrals', label: 'My Referrals', icon: Users },
  { href: '/ambassador/commissions', label: 'Commissions', icon: DollarSign },
  { href: '/ambassador/payouts', label: 'Payouts', icon: Wallet },
  { href: '/ambassador/materials', label: 'Marketing Materials', icon: Megaphone },
  { href: '/ambassador/settings', label: 'Settings', icon: Settings },
];
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
          ...
          <p className="text-gray-500 mb-6">You do not have permission to access the Ambassador Portal.</p>
            ...
            >
              <div className="p-5 border-b border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold">Ambassador Portal</span>
                </div>
