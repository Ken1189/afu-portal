...
const FALLBACK_JOBS: Record<string, JobDetail> = {
  ...
  'afu-1': {
    ...
    description: 'Build and lead financial operations across Africa. Manage $500M seed deployment, treasury operations, multi-currency mobile money, and investor-grade reporting.\n\nYou will own the entire finance function: budgeting, forecasting, audit, tax across multiple jurisdictions, and investor relations support.',
  ...
  'afu-3': {
    ...
    job_type: 'permanent', pay_rate: null, pay_type: 'negotiable', duration: 'Permanent', duration_description: 'Permanent',
    start_date: null, workers_needed: 1, farm_name: 'AFU HQ',
    description: 'Navigate a multi-layered corporate structure: Netherlands Foundation, Mauritius Holdings, country cooperatives, Lloyd\'s coverholder, and trade finance contracts across multiple African jurisdictions.\n\nBuild the legal frameworks for cooperative formation, farmer contracts, insurance policies, and cross-border trade.',
  ...
  'afu-6': {
    ...
    description: 'Lead and grow the engineering team from 2 to 25+ developers.\n\nScale a 200+ page Next.js platform with 40+ database tables, AI integration, and mobile money APIs to handle millions of farmers across Africa.',
  ...
  'afu-9': {
    ...
    job_type: 'permanent', pay_rate: null, pay_type: 'negotiable', duration: 'Permanent', duration_description: 'Permanent',
    start_date: null, workers_needed: 1, farm_name: 'AFU Technology',
    description: 'Build the EDMA blockchain platform on Polygon: AFUSD stablecoin, RWA tokenisation for farm assets, carbon credit trading.\n\nDevelop supply chain traceability and smart contracts for automated insurance payouts.',
    requirements: '5+ years in blockchain development with Solidity/Polygon experience. Understanding of RWA tokenisation and DeFi protocols.',
    skills: ['Solidity', 'Polygon', 'Smart contracts', 'RWA tokenisation', 'DeFi'],
  ...
  'afu-10': {
    ...
    job_type: 'permanent', pay_rate: null, pay_type: 'negotiable', duration: 'Permanent', duration_description: 'Permanent',
    start_date: null, workers_needed: 1, farm_name: 'AFU Technology',
    description: 'Build the information security programme across sensitive financial data, farmer PII, and payment transactions across Africa.\n\nAchieve SOC 2, ISO 27001, GDPR, POPIA, and PCI-DSS compliance.',
  ...
  'afu-11': {
    ...
    description: 'Build the operational machine across Africa: farming operations, lending, insurance, trade finance, and supply chain all running simultaneously.\n\nScale across Africa within 36 months.',
  ...
  'afu-18': {
    ...
    description: 'Oversee Uganda, Kenya, and Tanzania. Launch Uganda with thousands of pre-identified farmers.\n\nLeverage Kenya\'s fintech ecosystem and scale to 100,000+ farmers within 3 years across the EAC.',
  ...
  'afu-33': {
    ...
    job_type: 'permanent', pay_rate: null, pay_type: 'negotiable', duration: 'Permanent', duration_description: 'Permanent',
    start_date: null, workers_needed: 1, farm_name: 'AFU HQ',
    description: 'Build the support function from scratch: multilingual phone, WhatsApp, in-app chat, and email support across Africa.\n\nTrain the AI chatbot, track farmer satisfaction, and build the knowledge base.',
