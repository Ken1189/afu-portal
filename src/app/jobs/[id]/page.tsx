...
const FALLBACK_JOBS: Record<string, JobDetail> = {
  ...
  'afu-1': {
    ...
    description: 'Build and lead financial operations across 10 African countries. Manage $500M seed deployment, treasury operations, multi-currency mobile money, and investor-grade reporting.\n\nYou will own the entire finance function: budgeting, forecasting, audit, tax across multiple jurisdictions, and investor relations support.',
  ...
  'afu-3': {
    ...
    job_type: 'permanent', pay_rate: null, pay_type: 'negotiable', duration: 'Permanent', duration_description: 'Permanent',
    start_date: null, workers_needed: 1, farm_name: 'AFU HQ',
    description: 'Navigate a multi-layered corporate structure: Netherlands Foundation, Mauritius Holdings, country cooperatives, Lloyd\'s coverholder, and trade finance contracts across 10 African jurisdictions.\n\nBuild the legal frameworks for cooperative formation, farmer contracts, insurance policies, and cross-border trade.',
  ...
  'afu-6': {
    ...
    description: 'Lead and grow the engineering team from 2 to 25+ developers.\n\nScale a 200+ page Next.js platform with 40+ database tables, AI integration, and mobile money APIs to handle millions of farmers across 10 countries.',
  ...
  'afu-10': {
    ...
    job_type: 'permanent', pay_rate: null, pay_type: 'negotiable', duration: 'Permanent', duration_description: 'Permanent',
    start_date: null, workers_needed: 1, farm_name: 'AFU Technology',
    description: 'Build the information security program across sensitive financial data, farmer PII, and payment transactions in 10 countries.\n\nAchieve SOC 2, ISO 27001, GDPR, POPIA, and PCI-DSS compliance.',
  ...
  'afu-11': {
    ...
    description: 'Build the operational machine across 10 African countries: farming operations, lending, insurance, trade finance, and supply chain all running simultaneously.\n\nScale from 2 to 10 countries within 36 months.',
  ...
  'afu-15': {
    ...
    description: 'Manage SBLC origination, Letters of Credit processing, Hamilton Reserve Bank coordination, FX operations.\n\nOversee export pre-financing and warehouse receipt financing for agricultural commodity exports.',
  ...
  'afu-33': {
    ...
    job_type: 'permanent', pay_rate: null, pay_type: 'negotiable', duration: 'Permanent', duration_description: 'Permanent',
    start_date: null, workers_needed: 1, farm_name: 'AFU HQ',
    description: 'Build the support function from scratch: multilingual phone, WhatsApp, in-app chat, and email support across 10 countries.\n\nTrain the AI chatbot, track farmer satisfaction, and build the knowledge base.',
