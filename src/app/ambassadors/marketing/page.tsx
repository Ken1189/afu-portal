          ...
          <Section icon={Mic} title="Elevator Pitches" id="pitches">
            <div className="space-y-4">
              <ContentCard
                ...
                content="The African Farming Union is a one-stop platform that gives African farmers access to financing, insurance, inputs, guaranteed markets, and training. We serve over our community of farmers across Africa, helping them grow profitable, sustainable operations. Whether you're a farmer, supplier, or investor, AFU connects you to Africa's $50 billion agricultural opportunity."
              />
              <ContentCard
...
Today, AFU serves over our community of farmers managing more than thousands of hectares across Africa. The results speak for themselves: farmers who join AFU see significant increases in yield and income because they finally have the tools and support they need.
...
I'm an AFU Ambassador, and I can connect you directly with the team. Whether you're a farmer looking for better opportunities, a supplier wanting to reach more customers, or an investor seeking impact with returns, I'd love to help you explore what AFU can offer. Can I send you more information?`}
          ...
          <Section icon={BarChart3} title="Key Statistics" id="stats">
            ...
            <div className="flex justify-end">
              <CopyButton
                text="AFU Key Stats: our growing community of farmers served | multiple African countries | $50B market opportunity | growing hectares managed | Integrated platform: financing, insurance, inputs, offtake, processing, training"
...
The African Farming Union is changing the game for our growing community of farmers across Africa by providing financing, insurance, inputs, guaranteed markets, and training in one integrated platform.
...
#Agriculture #Africa #SmallholderFarmers #SustainableDevelopment`}
              ...
              <ContentCard
                ...
                content={`I'm helping African farmers access financing, insurance, and guaranteed markets through the African Farming Union. Over our community of farmers across Africa are already benefiting. If you're a farmer, supplier, or investor interested in African agriculture, message me or visit: [Your Referral Link]`}
              />
              <ContentCard
                title="Facebook Post"
...
They already serve our growing community of farmers across Africa, and the impact on farming communities is incredible.
...
I hope this message finds you well. I wanted to introduce you to the African Farming Union (AFU), an integrated agricultural platform that is helping over our community of farmers across Africa access the tools they need to grow profitably.
...
AFU is an integrated agricultural platform serving our growing community of farmers managing thousands of hectares across Africa. As a supplier partner, you would benefit from:
...
The African Farming Union (AFU) is an integrated agricultural platform operating across Africa, serving our growing community of farmers managing thousands of hectares. The platform provides financing, crop insurance, input supply, guaranteed offtake, processing, and farmer training.
          ...
          <Section icon={MessageSquare} title="Talking Points by Audience" id="talking-points">
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  <ul className="space-y-2 text-gray-600 text-sm">
                    <li className="flex items-start gap-2"><span style={{ color: '#5DB347' }}>&bull;</span> Reach our growing community of farmers across Africa through one platform.</li>
                  ...
                  <div className="mt-3 flex justify-end">
                    <CopyButton text="For Suppliers: Reach our growing community of farmers across Africa | Predictable aggregated demand | Payment security | Streamlined logistics via processing hubs | Long-term contracts" />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  <ul className="space-y-2 text-gray-600 text-sm">
                    ...
                    <li className="flex items-start gap-2"><span style={{ color: '#5DB347' }}>&bull;</span> Diversified portfolio across Africa and multiple crop types.</li>
                  ...
                  <div className="mt-3 flex justify-end">
                    <CopyButton text="For Investors: $50B market | Multi-country diversification across Africa | Insurance + offtake reduce risk | SDG-aligned impact | our growing community of farmers, growing hectares" />
                  </div>
                </div>
              </div>
          ...
          <Section icon={HelpCircle} title="FAQ Responses" id="faq">
            ...
            <div className="space-y-4">
              <ContentCard
                ...
                content="The African Farming Union (AFU) is an integrated agricultural platform that provides financing, crop insurance, agricultural inputs, guaranteed market access through offtake agreements, processing hub access, and farmer training programmes. We serve over our community of farmers managing more than thousands of hectares across Africa."
              />
              <ContentCard
              ...
              <ContentCard
                ...
                content="Yes. The African Farming Union is a registered organisation operating across Africa with over our community of active farmer members. AFU is headquartered in Botswana and works with established financial institutions, insurance providers, and offtake partners. You can visit our website, read our terms of service, and contact our team directly."
              />
              <ContentCard
              ...
              <ContentCard
                ...
                content="AFU currently operates across Africa in Africa, including Botswana, Kenya, Zimbabwe, Tanzania, Uganda, Zambia, Malawi, Mozambique, Ghana, and Nigeria, among others. We are continuously expanding to new markets."
              />
              <ContentCard
