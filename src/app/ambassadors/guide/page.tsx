          ...
          <AccordionItem icon={Megaphone} title="How to Promote AFU">
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 italic">
                &ldquo;The African Farming Union is a one-stop platform for African farmers. We provide financing, insurance, inputs, guaranteed markets, and training to help farmers grow their operations profitably. With over our community of farmers across Africa, AFU is transforming how agriculture works in Africa.&rdquo;
              </div>
              ...
              <ul className="space-y-2 ml-2">
                <li className="flex items-start gap-2">
                  <span style={{ color: '#5DB347' }} className="mt-1">&bull;</span>
                  AFU serves our growing community of farmers across Africa.
                </li>
                <li className="flex items-start gap-2">
                  <span style={{ color: '#5DB347' }} className="mt-1">&bull;</span>
          ...
          <AccordionItem icon={Users} title="Target Audiences">
            <div className="space-y-6">
              <div>
                ...
                <p>
                  African farmers face enormous challenges: limited access to finance, expensive inputs, no insurance safety net, and unreliable markets. AFU solves all of these in one platform. When speaking to farmers, emphasise that membership gives them access to affordable crop financing, free crop insurance, inputs at wholesale prices, guaranteed buyers for their produce, and expert training programmes. AFU already works with over our community of farmers managing more than thousands of hectares across Africa.
                </p>
              </div>
              <div>
