...
export const en: Translations = {
  ...
  cropDoctor: {
    ...
    analyzing: 'Analysing your crop...',
    uploadingImage: 'Uploading image...',
    analyzingLeaf: 'Analysing leaf patterns...',
...
export const nd: Translations = {
  ...
  aiAssistant: {
    ...
    weatherToday: 'Umkhathi walamuhla?',
...
export const sw: Translations = withOverrides({
  ...
  aiAssistant: {
    ...
    weatherToday: 'Hali ya hewa leo?', checkCrops: 'Angalia mazao yangu',
