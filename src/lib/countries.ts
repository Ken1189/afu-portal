...
export const COUNTRY_DATA: Country[] = [
  ...
  { name: 'Angola',                   code: 'AO', code3: 'AGO', flag: '🇦🇴', currency: 'AOA', currencySymbol: 'Kz',  phoneCode: '+244', region: 'Southern Africa', isAfuOperating: true },
  ...
  { name: 'Chad',                     code: 'TD', code3: 'TCD', flag: '🇹🇩', currency: 'XAF', currencySymbol: 'CFA', phoneCode: '+235', region: 'Central Africa',  isAfuOperating: true },
  ...
  { name: 'Eswatini',                 code: 'SZ', code3: 'SWZ', flag: '🇸🇿', currency: 'SZL', currencySymbol: 'L',   phoneCode: '+268', region: 'Southern Africa', isAfuOperating: true },
  ...
  { name: 'Ivory Coast',              code: 'CI', code3: 'CIV', flag: '🇨🇮', currency: 'XOF', currencySymbol: 'CFA', phoneCode: '+225', region: 'West Africa',     isAfuOperating: true },
  { name: 'Lesotho',                  code: 'LS', code3: 'LSO', flag: '🇱🇸', currency: 'LSL', currencySymbol: 'L',   phoneCode: '+266', region: 'Southern Africa', isAfuOperating: true },
  ...
  { name: 'Malawi',                   code: 'MW', code3: 'MWI', flag: '🇲🇼', currency: 'MWK', currencySymbol: 'MK',  phoneCode: '+265', region: 'Southern Africa', isAfuOperating: true },
  ...
  { name: 'Namibia',                  code: 'NA', code3: 'NAM', flag: '🇳🇦', currency: 'NAD', currencySymbol: '$',   phoneCode: '+264', region: 'Southern Africa', isAfuOperating: true },
  { name: 'Niger',                    code: 'NE', code3: 'NER', flag: '🇳🇪', currency: 'XOF', currencySymbol: 'CFA', phoneCode: '+227', region: 'West Africa',     isAfuOperating: false },
  { name: 'Rwanda',                   code: 'RW', code3: 'RWA', flag: '🇷🇼', currency: 'RWF', currencySymbol: 'FRw', phoneCode: '+250', region: 'East Africa',     isAfuOperating: true },
  { name: 'Senegal',                  code: 'SN', code3: 'SEN', flag: '🇸🇳', currency: 'XOF', currencySymbol: 'CFA', phoneCode: '+221', region: 'West Africa',     isAfuOperating: true },
