...
const boardOfDirectors: BoardMember[] = [
  ...
  },
  {
    ...
    bio: 'Visionary founder building the full-stack agriculture development platform for Africa. Background in agricultural finance, commodity trading, and pan-African market development.',
    country: 'Senegal',
